...
/**
 * Servlet implementation class NewUserSentitem
 */
@WebServlet("/NewUserSentitem")
public class NewUserSentitem extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="update message set sstatus=? where msgid=?";
			try
			{
		...
		{
			response.sendRedirect("/UniversityHelpdesk/jsp/newusersentitems.jsp");// TODO Auto-generated method stub
		}
		else
