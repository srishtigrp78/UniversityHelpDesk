...
<title>UNIVERSITY HELPDESK | STUDENT</title>
</head>
<body>
...
<table width="100%">
<tr>
<th style="top: 0%;left: 42%;position: absolute;font-size: 40px;color: blue;"> ADD STUDENT </th>
...
<img width="100%" height="100%" src="/UniversityHelpdesk/images/student.png" style="border-radius: 25px">
</div>


<div style="top: 22%;left: 35%;width: 45%;height: 60%;position: absolute;font-size: 18px">
...
<form action="/UniversityHelpdesk/AddStudent" method="post" onsubmit="return chkmain()">   
	<table style="margin-left:25%;">
			<tr>
				<td>FULL NAME</td><td colspan=2><input type="text" name="txtfullname" id="txtfullname" placeholder="Enter full NAME"/></td>
			</tr>
			<tr>
			<td>BRANCH</td><td colspan=2><input type="text" name="txtprof" id="txtprof" placeholder="Enter BRANCH"/></td></tr>
